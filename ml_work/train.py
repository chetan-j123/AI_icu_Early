...
print("starting_time = ",start_time,"Seconds")
import numpy as np
import pandas as pd
...
#print(df.info)
#print(df.describe)
#print(df.duplicated(subset=["patient"]).sum())
...
#in the data of the total 403876 4l patients dont face deterioration in next hrs while 3876 patients faces deterioration in  next 1 hrs
#df.to_csv("cleaned_valuable_dataset.csv",index=False)
#load cleaned dataset
#df=pd.read_csv("data/cleaned_valuable_dataset.csv")
#print(df.info())
...
print("top 20 features for rf",imp_features_for_rf.head(20))  # top 20
...
end_time = time.time()
print("end timme = ",end_time,"s") 
print("ex time= ",end_time-start_time,"Seconds")